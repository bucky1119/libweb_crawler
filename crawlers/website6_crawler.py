...
class Website6Crawler(AbstractCrawler):
    ...
    async def crawl(self) -> List[ArticleContent]:
        ...
        while self.running_state and self.page_count <= self.PAGE_SIZE:
            ...
            container_list = selector.xpath('//div[@class="m-news-article-list--vertical m-news-article-list--secondary"]')
            ...
            #self.url = urljoin(self.url, selector.xpath('.//a/@href').get())
